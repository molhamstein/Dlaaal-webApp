        ...
        if (type == -1) {
            ...
            if (data.search.title != "" && data.search.title != null) {
                if (fiedsQuery_1.length == 0)
                    ...
                    query = { "where": { "and": fiedsQuery_1, "title": { "like": data.search.title }, "categoryId": data.search.category, "cityId": data.search.city, "subCategoryId": data.search.subCategory, "price": { "between": [data.search.min, data.search.max.toFixed(25)] } }, "order": "createdAt DESC", "limit": limit, "skip": skip };
            }
                ...
                query = { "where": { "and": fiedsQuery_1, "categoryId": data.search.category, "cityId": data.search.city, "subCategoryId": data.search.subCategory, "price": { "between": [data.search.min, data.search.max.toFixed(25)] } }, "order": "createdAt DESC", "limit": limit, "skip": skip };
        }
        if (!(type == 0 && isTopSearch)) {
            this.loader = true;
