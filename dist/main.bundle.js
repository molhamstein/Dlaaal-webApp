...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_15__angular_core__["K" /* NgModule */])({
            declarations: [
            ...
            imports: [
                // Main
                __WEBPACK_IMPORTED_MODULE_14__angular_platform_browser__["a" /* BrowserModule */], __WEBPACK_IMPORTED_MODULE_20__angular_forms__["c" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_19__angular_platform_browser_animations__["a" /* BrowserAnimationsModule */], __WEBPACK_IMPORTED_MODULE_18__angular_common_http__["b" /* HttpClientModule */],
                // Route
                __WEBPACK_IMPORTED_MODULE_5__angular_router__["b" /* RouterModule */].forRoot(__WEBPACK_IMPORTED_MODULE_4__app_routes__["a" /* routes */])
                // material
                ,
                __WEBPACK_IMPORTED_MODULE_11__angular_material_dialog__["c" /* MatDialogModule */], __WEBPACK_IMPORTED_MODULE_12__angular_material__["b" /* MatFormFieldModule */], __WEBPACK_IMPORTED_MODULE_13__angular_material_input__["b" /* MatInputModule */], __WEBPACK_IMPORTED_MODULE_16_ngx_infinite_scroll__["a" /* InfiniteScrollModule */]
            ],
...
var HomePageComponent = /** @class */ (function () {
    ...
    HomePageComponent.prototype.ngOnInit = function () {
        ...
        this.APIServ.get("advertisemets/actived").subscribe(function (data) {
            _this.advertisemets = data;
        });
        if (this.isLogin) {
    ...
    HomePageComponent.prototype.getAdvertisemets = function (type, data) {
        var _this = this;
        // let query: string;
        var query;
        if (type == 0) {
